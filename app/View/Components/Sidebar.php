...
class Sidebar extends Component
{
    ...
    public function __construct()
    {
        $this->menus = [
            ...
            [
                'name' => 'Transaksi',
                'route' => 'transaction.index', // placeholder
                'url' => '#',
            ...
            [
                ...
                'submenus' => [
                    ['name' => 'Semua Produk', 'url' => '#', 'route' => 'product.index'],
                    ['name' => 'Tambah Produk', 'url' => '#', 'route' => 'product.create'],
                    ['name' => 'Kategori', 'url' => '#', 'route' => 'category.index'],
                    ['name' => 'Brand', 'url' => '#', 'route' => 'brand.index'],
                    ['name' => 'Stok Barang', 'url' => '#', 'route' => 'product.stock'],
                    ['name' => 'Stock Opname', 'url' => '#', 'route' => 'product.stock_opname'],
                    ['name' => 'Barcode Generator', 'url' => '#', 'route' => 'product.barcode'],
                ]
            ],
            [
                'name' => 'Pelanggan',
            ...
            [
                'name' => 'Laporan',
                'route' => 'report.index', // placeholder
                'url' => '#',
